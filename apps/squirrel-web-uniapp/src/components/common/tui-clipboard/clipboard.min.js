...
class ClipboardAction {
  constructor(t) {
    this.resolveOptions(t), this.initSelection();
  }
  resolveOptions(t = {}) {
  ...
  selectTarget() {
    (this.selectedText = select(this.target)), this.copyText();
  }
  copyText() {
    let t;
    try {
...
let is = {
  ...
  nodeList: function (t) {
    ...
    return void 0 !== t && ('[object NodeList]' === e || '[object HTMLCollection]' === e) && 'length' in t && (0 === t.length || exports.node(t[0]));
  },
  string: function (t) {
...
function closest(t, e) {
  for (; t && t.nodeType !== DOCUMENT_NODE_TYPE; ) {
    if ('function' == typeof t.matches && t.matches(e)) return t;
    t = t.parentNode;
  }
}
function _delegate(t, e, i, n, r) {
  var o = listener.apply(this, arguments);
  return (
  ...
  return 'function' == typeof t.addEventListener
    ...
    : ('string' == typeof t && (t = document.querySelectorAll(t)),
      Array.prototype.map.call(t, function (t) {
        return _delegate(t, e, i, n, r);
      }));
}
function listener(t, e, i, n) {
  return function (i) {
    (i.delegateTarget = closest(i.target, e)), i.delegateTarget && n.call(t, i);
  };
}
function listen(t, e, i) {
  if (!t && !e && !i) throw new Error('Missing required arguments');
  if (!is.string(e)) throw new TypeError('Second argument must be a String');
  if (!is.fn(i)) throw new TypeError('Third argument must be a Function');
  if (is.node(t)) return listenNode(t, e, i);
  if (is.nodeList(t)) return listenNodeList(t, e, i);
  if (is.string(t)) return listenSelector(t, e, i);
  throw new TypeError('First argument must be a String, HTMLElement, HTMLCollection, or NodeList');
}
function listenNode(t, e, i) {
  return (
...
function listenSelector(t, e, i) {
  return delegate(document.body, t, e, i);
}
class Clipboard extends Emitter {
  constructor(t, e) {
    super(), this.resolveOptions(e), this.listenClick(t);
  }
  resolveOptions(t = {}) {
    (this.action = 'function' == typeof t.action ? t.action : this.defaultAction),
      (this.target = 'function' == typeof t.target ? t.target : this.defaultTarget),
      (this.text = 'function' == typeof t.text ? t.text : this.defaultText),
      (this.container = 'object' == typeof t.container ? t.container : document.body);
  }
  listenClick(t) {
    this.listener = listen(t, 'click', t => this.onClick(t));
  }
  onClick(t) {
    const e = t.delegateTarget || t.currentTarget;
    this.clipboardAction && (this.clipboardAction = null),
      (this.clipboardAction = new ClipboardAction({ action: this.action(e), target: this.target(e), text: this.text(e), container: this.container, trigger: e, emitter: this }));
  }
  defaultAction(t) {
    return getAttributeValue('action', t);
  }
  defaultTarget(t) {
    const e = getAttributeValue('target', t);
    if (e) return document.querySelector(e);
  }
  static isSupported(t = ['copy', 'cut']) {
    const e = 'string' == typeof t ? [t] : t;
    let i = !!document.queryCommandSupported;
    return (
      e.forEach(t => {
  ...
  defaultText(t) {
    return getAttributeValue('text', t);
  }
  destroy() {
