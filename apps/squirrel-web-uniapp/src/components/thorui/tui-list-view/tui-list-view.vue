<template>
  <view class="tui-list-view tui-view-class" :class="{ 'tui-radius': radius && radius != '0' }" :style="{ backgroundColor: backgroundColor, marginTop: marginTop, borderRadius: radius + 'rpx' }">
