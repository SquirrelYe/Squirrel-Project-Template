<template>
  <view class="tui-slide-vcode" :style="{ width: slideBarWidth + 'px', height: slideBlockWidth + 'px', backgroundColor: backgroundColor }">
    ...
    <view class="tui-slide-glided" :style="{ backgroundColor: getActiveBgColor }">
      ...
      <view v-else :style="{ width: slideBarWidth + 'px', height: slideBlockWidth + 'px', fontSize: size + 'rpx' }" class="tui-active__text">拖动滑块验证</view>
    </view>
    <view
    ...
    >
      ...
      <text class="tui-slide-icon tui-icon-check_mark" :style="{ fontSize: iconSize + 'rpx', color: getCheckColor }" v-if="isPass"></text>
    </view>
    <!-- #endif -->
    ...
    <view
      class="tui-slider-block"
      :class="{ 'tui-slider__reset': resetAni }"
