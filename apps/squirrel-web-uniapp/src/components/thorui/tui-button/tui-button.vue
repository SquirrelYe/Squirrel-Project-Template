<template>
  ...
  >
    ...
    <view class="tui-button__border" :class="[getShapeClass(shape, plain), getDisabledClass(disabled, type, plain)]" :style="{ borderColor: getBgColor(type) }" v-if="!link && plain"></view>
  </view>
</template>
